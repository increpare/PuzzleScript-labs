...
typedef struct ps_runtime_counters {
    ...
    uint64_t mask_rebuild_object_rows;
    uint64_t mask_rebuild_object_columns;
    uint64_t mask_rebuild_movement_rows;
    uint64_t mask_rebuild_movement_columns;
    uint64_t mask_rebuild_object_row_cells_scanned;
    uint64_t mask_rebuild_object_column_cells_scanned;
    uint64_t mask_rebuild_movement_row_cells_scanned;
    uint64_t mask_rebuild_movement_column_cells_scanned;
    uint64_t mask_rebuild_object_count_full_rebuilds;
    uint64_t mask_rebuild_object_count_full_rebuild_cells_scanned;
    uint64_t mask_rebuild_object_count_index_rebuilds;
    uint64_t mask_rebuild_object_count_index_bits_visited;
    uint64_t mask_dirty_object_cells_changed;
    uint64_t mask_dirty_object_bits_changed;
    uint64_t mask_dirty_object_bits_cleared;
    uint64_t mask_dirty_object_marks;
    uint64_t mask_dirty_object_add_only_marks;
    uint64_t mask_dirty_object_clear_marks;
    uint64_t mask_dirty_object_refcount_bit_updates;
    uint64_t mask_dirty_object_refcount_fallbacks;
    uint64_t mask_dirty_movement_cells_changed;
    uint64_t mask_dirty_movement_bits_changed;
    uint64_t mask_dirty_movement_bits_cleared;
    uint64_t mask_dirty_movement_marks;
    uint64_t mask_dirty_movement_clear_marks;
    uint64_t mask_dirty_movement_line_all_marks;
