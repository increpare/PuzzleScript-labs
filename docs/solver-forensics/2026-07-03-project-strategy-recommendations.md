...
- **Native interpreter** = production. Gets the N-series investment
  ...
  candidates; NX1 smoke-50 movement-anchor attribution has started, and NX2
  mimalloc is still unrun).
...
| N1/N2 moving-tiles bitboard + static anchor masks | live, top priority | NX1 smoke-50 attribution started: 662643668 movement-anchor scanned cells over 494410 generated states; run benchmark-game sample, then NX2 |
