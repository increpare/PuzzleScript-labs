...
| N4-N7, N9 | residual runtime tier measured; N4a done, N4b/N5a/N7/N9a rejected; N4c promoted only for wide object masks | N4a's add-only movement dirty guard is a small validated win (+2.0% smoke-50 and +1.7% named portfolio raw step-throughput vs N1, solved splits unchanged); N4b rebuild-on-read reduced the tiny `push_goal` dirty counter canary but regressed focus-50 median wall +20.3% in the stale-board version and +51.5% with exact board reads. N4c exact object refcount masks reuse the object-cell index, eliminating 96.4M secondary board-seed scans; broad smoke was noise-level, the four-word portfolio gained +3.36%, and N4c now enables automatically at `Game::wordCount >= 3`. N7's per-cell word-plane prototype regressed throughput -6.9% and materialization +15.5%. N9a found 733/1,540 multi-rule groups certified single-pass and confirmation visits were 10.84% of smoke rule visits, but eliminating 1.76M of those visits left three-run throughput neutral/slightly negative (87.007 -> 86.861 states/ms, -0.17%) with identical 99/48/3 samples; the four-word game exposed only 1.79% addressable visits. Its consumer was backed out while behavior-neutral confirmation counters remain. Next runtime work needs a new counter-proven expensive operation, not another broad rule-visit reduction |
