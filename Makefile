...
help:
	...
	@echo "  make pocket_card_schematic_tests   Test canonical and legacy Pocket Card electronics sources"
	@echo "  make pocket_card_kicad             Regenerate legacy Pocket Card compatibility artifacts and test"
...
pocket_card_schematic_tests: pocket_card_electronics_tests
