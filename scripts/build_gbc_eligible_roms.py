...
ELIGIBLE_GAMES: tuple[tuple[str, str], ...] = (
    ...
    ("short-adventure-in-sticky-wall-land", "src/tests/good_games/short adventure in sticky wall land.txt"),
    ...
    ("recondite-star-sector-sigma", "src/tests/good_games/Recondite Star Sector Sigma.txt"),
