...
def main():
    ...
    # Placed overlays (separate solids, shell model space) — not fab parts.
    import place_preview
    place_preview.main()
    lines.append("preview/                       — pcb + tips + caps placed "
                 "(separate files, model space)")
    ...
    print("preview/: pcb + tips + caps already in shell model space "
          "(separate meshes — drag onto shell_front.stl).")
